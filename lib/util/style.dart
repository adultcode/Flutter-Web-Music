...
class Text_Style{
  ...
  static const id_style_small = TextStyle(fontSize: 13.0,fontWeight: FontWeight.w400,color: MyColor.id_color);
  static const email_style = TextStyle(fontSize: 13.0,fontWeight: FontWeight.w200,color: MyColor.grey_color);
  static const email_style_small = TextStyle(fontSize: 10.0,fontWeight: FontWeight.w200,color: MyColor.grey_color);
  ...
  static const search_hint_style_small = TextStyle(fontSize: 12.0,fontWeight: FontWeight.w400,color: MyColor.grey_color);
  static const search_text_style = TextStyle(fontSize: 13.0,fontWeight: FontWeight.w400,color: MyColor.id_color);
  static const search_text_style_small = TextStyle(fontSize: 12.0,fontWeight: FontWeight.w400,color: MyColor.id_color);

  //upgrade
  static const upgrade_text_style = TextStyle(fontSize: 13.0,fontWeight: FontWeight.w400,color: Colors.white);
  static const upgrade_text_style_small = TextStyle(fontSize: 11.0,fontWeight: FontWeight.w300,color: Colors.white);

  //chart
  static const billboard_style = TextStyle(fontSize: 16.0,fontWeight: FontWeight.w600,color: MyColor.id_color);
  static const billboard_style_small = TextStyle(fontSize: 14.0,fontWeight: FontWeight.w600,color: MyColor.id_color);
  static const songname_style = TextStyle(fontSize: 14.0,fontWeight: FontWeight.w600,color: MyColor.id_color);
  static const songname_style_small = TextStyle(fontSize: 12.0,fontWeight: FontWeight.w600,color: MyColor.id_color);
  static const asrtist_style = TextStyle(fontSize: 14.0,fontWeight: FontWeight.w500,color: MyColor.grey_color);
  static const asrtist_style_small = TextStyle(fontSize: 12.0,fontWeight: FontWeight.w500,color: MyColor.grey_color);
}